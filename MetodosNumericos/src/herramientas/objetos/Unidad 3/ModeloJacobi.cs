...
{
    public class ModeloJacobi : Modelo
    {
        ...
        public ModeloJacobi(int cifrasSignificativas, double[] terminosIndependientes, double[] constantesV, double[] constantesW, double[] constantesX, double[] constantesY, double[] constantesZ, double[] valorInicial)
        {
        ...
        private void iteraciones()
        {
            ...
            while (/*_Resultado.ErrorRelativoPorcentual1 > _Resultado.ToleranciaPorcentual && _Resultado.ErrorRelativoPorcentual2 > _Resultado.ToleranciaPorcentual && */_Resultado.ErrorRelativoPorcentual3 > _Resultado.ToleranciaPorcentual && _Resultado.ErrorRelativoPorcentual4 > _Resultado.ToleranciaPorcentual && _Resultado.ErrorRelativoPorcentual5 > _Resultado.ToleranciaPorcentual)
            {
                _Resultado.ValorInicial1 =
                  ...
                  + _constantesV[0] * _Resultados.ElementAt(i - 1).ValorInicial1
                  + _constantesW[0] * _Resultados.ElementAt(i - 1).ValorInicial2
                  + _constantesX[0] * _Resultados.ElementAt(i - 1).ValorInicial3
                  + _constantesY[0] * _Resultados.ElementAt(i - 1).ValorInicial4
                  + _constantesZ[0] * _Resultados.ElementAt(i - 1).ValorInicial5;
                _Resultado.ValorInicial2 =
                    _terminosIndependientes[1]
                  + _constantesV[1] * _Resultados.ElementAt(i - 1).ValorInicial1
                  + _constantesW[1] * _Resultados.ElementAt(i - 1).ValorInicial2
                  + _constantesX[1] * _Resultados.ElementAt(i - 1).ValorInicial3
                  + _constantesY[1] * _Resultados.ElementAt(i - 1).ValorInicial4
                  + _constantesZ[1] * _Resultados.ElementAt(i - 1).ValorInicial5;
                _Resultado.ValorInicial3 =
                    _terminosIndependientes[2]
                  + _constantesV[2] * _Resultados.ElementAt(i - 1).ValorInicial1
                  + _constantesW[2] * _Resultados.ElementAt(i - 1).ValorInicial2
                  + _constantesX[2] * _Resultados.ElementAt(i - 1).ValorInicial3
                  + _constantesY[2] * _Resultados.ElementAt(i - 1).ValorInicial4
                  + _constantesZ[2] * _Resultados.ElementAt(i - 1).ValorInicial5;
                _Resultado.ValorInicial4 =
                    _terminosIndependientes[3]
                  + _constantesV[3] * _Resultados.ElementAt(i - 1).ValorInicial1
                  + _constantesW[3] * _Resultados.ElementAt(i - 1).ValorInicial2
                  + _constantesX[3] * _Resultados.ElementAt(i - 1).ValorInicial3
                  + _constantesY[3] * _Resultados.ElementAt(i - 1).ValorInicial4
                  + _constantesZ[3] * _Resultados.ElementAt(i - 1).ValorInicial5;
                _Resultado.ValorInicial5 =
                    _terminosIndependientes[4]
                  + _constantesV[4] * _Resultados.ElementAt(i - 1).ValorInicial1
                  + _constantesW[4] * _Resultados.ElementAt(i - 1).ValorInicial2
                  + _constantesX[4] * _Resultados.ElementAt(i - 1).ValorInicial3
                  + _constantesY[4] * _Resultados.ElementAt(i - 1).ValorInicial4
                  + _constantesZ[4] * _Resultados.ElementAt(i - 1).ValorInicial5;
